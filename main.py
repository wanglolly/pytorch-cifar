...
def train(epoch, filewriter):
    ...
    filewriter.writerow(trainHeader)           
    scheduler.step()

def test(epoch, filewriter):
    global best_acc
    net.eval()
    test_loss = 0
    correct = 0
    ...
    testHeader = [epoch, (test_loss/(batch_idx+1)), 100.*correct/total]
    filewriter.writerow(testHeader)
